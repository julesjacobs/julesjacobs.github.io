(function () {
  ...
  const pages = [
    ...
    },
    {
      ...
      navTitle: "Why",
      path: "examples/01-why-oxcaml-exists.html",
    },
    {
      key: "parallelism",
      number: "01",
      ...
      path: "examples/02-parallelism-contention-portability.html",
    },
    {
      key: "allocation",
      number: "02",
      title: "Allocation",
      navTitle: "Allocation",
      path: "examples/03-locality-stack-zeroalloc.html",
    },
    {
      key: "representation",
      number: "03",
      ...
      path: "examples/04-representation.processed.html",
      aliases: ["examples/04-representation.html"],
    },
  ];
