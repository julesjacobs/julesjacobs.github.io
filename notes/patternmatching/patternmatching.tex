...
\newcommand{\One}{\mathsf{Zero}}
  This is a note about compiling ML-style pattern matching to decision trees. I try to keep it as simple as possible while still presenting the key idea of efficient pattern match compilation.
}
