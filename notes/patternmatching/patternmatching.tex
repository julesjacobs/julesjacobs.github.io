...
\noindent
\href{https://yorickpeterse.com/}{Yorick Peterse} implemented a much more advanced version in Rust:  \\
\url{https://gitlab.com/yorickpeterse/pattern-matching-in-rust/-/tree/main/jacobs2021}.
This version supports integer literals and ranges, or-patterns, and guards.
The repository also contains a good README explaining the algorithm and how to implement the advanced features.
The syntax ``$a \is pat$'' was invented by Yorick. I initially used ``$a = pat$'', but I think Yorick's syntax is clearer.
