...
\lstdefinelanguage{Scala}{
  keywords={def, class, object, extends, case, for, if, else, var, val, match},
  keywordstyle=\color{Maroon!80},
  morekeywords=[2]{Set,List,Re,Re2,Alt,Alt2,Seq,Seq2,Star,Star2,Chr,Chr2,Emp,Eps,Tm,Var,Lam,App,Sem,LamS,AppS,TmS,Char,String,Int},
