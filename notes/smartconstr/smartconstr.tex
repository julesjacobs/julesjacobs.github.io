...
\begin{abstract}
  ...
  \end{align*}
  The key idea is that the smart term constructors always create normal forms by
  performing an applicable rewrite rule before returning the term that they construct.
