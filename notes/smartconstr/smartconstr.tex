...
\begin{abstract}
  ...
  \end{align*}
  The key idea is that the smart constructors always create normal forms:
  we first perform applicable rewrite rules to the new term that we want to construct.
