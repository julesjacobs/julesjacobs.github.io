...
Similarly, the entry $U_{xy}$ of the unitary matrix, is the \emph{probability amplitude} of next state being $y$, if the state is currently $x$.
...
\textbf{In summary, what is a quantum computer:}
\begin{itemize}
