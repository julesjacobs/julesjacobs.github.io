...
If there are multiple quantifiers you can do \tac{eapply (H _ _ 4 _)}, which means that you instantiate the third one with $4$ and let Coq determine the ones where you put $\_$.
...
You can also specify which occurence you want to rewrite: \tac{rewrite H at 2} rewrites only the second occurence of the pattern $n + m$.
