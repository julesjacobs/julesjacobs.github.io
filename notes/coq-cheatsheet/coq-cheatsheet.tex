...
For instance if the goal is $\exists n, P n$ and you have $H : P(3)$, then you can type \tac{eexists. apply H.} This automatically determines $n=3$ from the hypothesis.
