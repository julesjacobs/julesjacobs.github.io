...
In other words: the T-edges form a forest, and each C-edge is part of a cycle. The cycle that a C-edge is a part of may use other C-edges as well as T-edges, but a cycle cannot consist solely of T-edges. \Cref{fig:tcgraph} contains an example of a tree-cyclic graph.
