...
It is essential that we consider directed forests. The correspondence between undirected spanning trees and directed spanning trees rooted at $1$ fails to work as smoothly for $k > 1$. Thus it could be argued that Kirchoff's theorem is really a theorem about directed forests.
