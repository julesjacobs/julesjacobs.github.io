...
\begin{figure}
  ...
  \begin{tikzpicture}[spring layout,node distance=30pt, random seed=1]
    \input{tcgraph1.tikz}
  \end{tikzpicture}
  \caption{A tree-cyclic graph. T-edges are the red dotted edges, and C-edges are the solid blue edges.}
  \label{fig:tcgraph}
\end{figure}
...
\Cref{fig:tcgraph} contains an example tree-cyclic graph.
