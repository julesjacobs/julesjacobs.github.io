...
\begin{center}
  \begin{tikzpicture}
    ...
    \draw [arrow, bend right=25] (l3) edge node[midway,below,sloped] {$r_4 s^* t_2$} (r2);
  \end{tikzpicture}
\end{center}
...
\bigskip
\noindent I don't claim that anything I've said here is new; it is extremely likely that it is not. Nevertheless, I couldn't find it in the standard texts or wikipedia. It is, of course, possible that what I wrote here is nonsense. However, if it isn't, then perhaps we could make the lives of millions of computer science students a tiny bit easier?
